...
import it.moondroid.smbexplorer.exceptions.LocationInvalidException;
...
public final class PreferenceHelper {
	...
	public boolean useQuickActions() {
		return PreferenceManager.getDefaultSharedPreferences(mContext)
				.getBoolean(PREF_USE_QUICKACTIONS, false);
	}
	...
	public GenericFile getStartDir() {
		...
		GenericFile homeDir = GenericFile.newInstance(ExplorerApp.FILESYSTEM_TYPE, dirPath);
		...
		if (homeDir.exists() && homeDir.isDirectory()) {
			...
			return GenericFile.newInstance(ExplorerApp.FILESYSTEM_TYPE, startPath);
	...
	public int getTheme() {
		...
		//TODO
        return ExplorerApp.THEME_WHITE;
